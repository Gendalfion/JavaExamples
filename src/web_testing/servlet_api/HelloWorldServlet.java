...
/**
 * Демонстрация простейшего HTTP-сервлета "Hello, World!"
 *
 * Для запуска примера понадобится:
 * <p>1. Установить Eclipse для Java EE (Enterprise Edition)<br>
 * <p>2. Скачать сервер для запуска веб-приложений.<br>
 * 	В нашем случае скачан сервер Apache Tomcat v9.0 (архив расположен в корне проекта MyStudy)<br>
 ...
 *  каталогов проекта (в папку: WebContent/WEB-INF/lib/, "правильные" способы почему-то не работали)<br>
...
public class HelloWorldServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Устанавливаем MIME-тип отпарвляемых данных:
