...
public interface BibleWebserviceSoap {
    ...
    @RequestWrapper(localName = "GetBibleWordsByChapterAndVerse", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsByChapterAndVerse")
    @ResponseWrapper(localName = "GetBibleWordsByChapterAndVerseResponse", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsByChapterAndVerseResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsbyKeyWord", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsbyKeyWord")
    @ResponseWrapper(localName = "GetBibleWordsbyKeyWordResponse", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsbyKeyWordResponse")
    ...
    @RequestWrapper(localName = "GetBookTitles", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBookTitles")
    @ResponseWrapper(localName = "GetBookTitlesResponse", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBookTitlesResponse")
    ...
    @RequestWrapper(localName = "GetBibleWordsByBookTitleAndChapter", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsByBookTitleAndChapter")
    @ResponseWrapper(localName = "GetBibleWordsByBookTitleAndChapterResponse", targetNamespace = "http://www.webserviceX.NET", className = "java_api_testing.net_api.ws_testing.generated.GetBibleWordsByBookTitleAndChapterResponse")
