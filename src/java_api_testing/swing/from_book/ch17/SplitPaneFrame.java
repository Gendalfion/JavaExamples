...
public class SplitPaneFrame {
  public static void main(String[] args) {
	...
	JLabel leftImage = new JLabel( new ImageIcon( SplitPaneFrame.class.getResource(fileOne) ) );
    Component left = new JScrollPane(leftImage);
	JLabel rightImage = new JLabel( new ImageIcon( SplitPaneFrame.class.getResource(fileTwo) ) );
