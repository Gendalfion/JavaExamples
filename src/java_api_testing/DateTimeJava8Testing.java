...
/**
 * <p>Демонстрация нового API, добавленном в Java 8, для работы с датой и временем
 * 
 * <p>Данный пример взят из статьи: 
 * <a href="http://www.mscharhag.com/2014/02/java-8-datetime-api.html">A deeper look into the Java 8 Date and Time API</a>
 */
public class DateTimeJava8Testing {
